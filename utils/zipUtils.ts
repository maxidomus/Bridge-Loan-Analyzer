export const getStateFromZip = (zip: string): string => {
  ...
  if (prefix >= 600 && prefix <= 690) return 'CT';
  ...
  if (prefix >= 390 && prefix <= 490) return 'ME';
  if (prefix >= 206 && prefix <= 219) return 'MD';
  if (prefix >= 100 && prefix <= 270) return 'MA';
  ...
  if (prefix >= 300 && prefix <= 380) return 'NH';
  if (prefix >= 700 && prefix <= 890) return 'NJ';
  ...
  if (prefix >= 280 && prefix <= 290) return 'RI';
  if (prefix >= 290 && prefix <= 299) return 'SC';
  if (prefix >= 570 && prefix <= 577) return 'SD';
  if (prefix >= 370 && prefix <= 385) return 'TN';
  if (prefix >= 750 && prefix <= 799) return 'TX';
  if (prefix >= 840 && prefix <= 847) return 'UT';
  if (prefix >= 500 && prefix <= 590) return 'VT';
